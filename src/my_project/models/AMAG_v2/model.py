...
class MagnitudeNet(WaveformModel):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        last_filters = self.bottleneck_filters
        ...
        # Output head - single magnitude value per timestep
        self.out = nn.Conv1d(last_filters, 1, 1, padding="same")
        ...
        for i, ((conv_up, bn1, conv_same, bn2), skip) in enumerate(
            ...
            if x.shape[-1] > skip.shape[-1]:
                ...
                x = x[
                    ...
                    :,
                    diff
                    // 2 : -(diff - diff // 2) if diff > diff // 2 else x.shape[-1],
                ]
